...
**Access:** https://visiomatix.in/robots.txt
...
**Access:** https://visiomatix.in/sitemap.xml
...
2. Add property: https://visiomatix.in
3. Verify ownership
4. Submit sitemap: https://visiomatix.in/sitemap.xml
...
```bash
curl https://visiomatix.in/robots.txt
```

### Test sitemap.xml

```bash
curl https://visiomatix.in/sitemap.xml
```
