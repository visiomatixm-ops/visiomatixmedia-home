        ...
        <div className="footer-grid">
          ...
          <div className="footer-col">
            ...
            >
              ...
              <li>
                <NavLink style={{ color: "#ffffff" }} to="/services/custom-website-development">
              ...
              <li>
                <NavLink style={{ color: "#ffffff" }} to="/services/business-software-solutions">
              ...
              <li>
                <NavLink style={{ color: "#ffffff" }} to="/services/market-audience-research">
                  Competitor & Market Research
                </NavLink>
              </li>
              <li>
                <NavLink style={{ color: "#ffffff" }} to="/services/custom-e-commerce-development">
          ...
          <div className="footer-col">
            ...
            > */}
              ...
              <li>
                <NavLink style={{ color: "#ffffff" }} to="/services/digital-marketing">
                  Services
                </NavLink>
              </li>
              <li>
              ...
              <li>
                <NavLink style={{ color: "#ffffff" }} to="/services/web-and-app-development-services">
                  IT Services
                </NavLink>
              </li>
            </motion.ul>
