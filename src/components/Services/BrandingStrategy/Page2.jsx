      ...
      <section className="digital-marketing-services-2-2">
        ...
        >
          <p className="second-text">
            Branding and strategy at Visiomatix Media go beyond logos and
            visuals we build strategic brand foundations that drive recognition,
            trust, and long term business growth. Our structured, insight driven
            branding approach ensures every brand aligns with business goals,
            resonates with the right audience, and delivers measurable brand
          ...
          >
            <motion.li className="second-text" variants={fadeUp}>
              Strategic Brand Architecture Future ready brand frameworks aligned
              with business goals, audience insights, and long term growth.
            </motion.li>
            <motion.li className="second-text" variants={fadeUp}>
              Performance Driven Brand Strategy Focused on clarity,
              differentiation, and market impact to strengthen brand positioning
              and recall.
            </motion.li>
            <motion.li className="second-text" variants={fadeUp}>
              Consistent Brand Systems & Standards Clear guidelines and
              structured frameworks ensure consistency, maintainability, and
              professional execution.
            </motion.li>
            <motion.li className="second-text" variants={fadeUp}>
              High Impact Brand Experience Purpose driven brand experiences that
              enhance usability, engagement, and customer trust.
            </motion.li>
            <motion.li className="second-text" variants={fadeUp}>
              Brand Stability & Market Credibility Strong brand governance and
              consistency ensure long term credibility, recognition, and
              compliance.
            </motion.li>
          </motion.ul>
        </motion.div>
