      ...
      <section className="digital-marketing-services-2-2">
        ...
        >
          <div className="column-2 custom-border-2 right-pad-30">
            <Benefit
              img={frame1}
              title="Business-Aligned Integration Architecture"
            ...
            <Benefit
              img={frame2}
              title="Secure & Governed Integrations"
          ...
          <div className="column-2 custom-border-2 left-pad-50 right-pad-30">
            <Benefit
              img={frame3}
              title="Scalable & Future-Ready Connectivity"
            ...
            <Benefit
              img={frame4}
              title="Seamless Cross-Platform Synchronization"
        ...
        >
          <p className="second-text">
            At Visiomatix Media, System Integration Services go beyond
            connecting software — we build unified, scalable, and secure digital
            ecosystems that drive operational efficiency and long-term business
            performance. Our strategic, architecture-driven integration approach
            ensures every system works in sync with your business objectives,
            data workflows, and enterprise infrastructure.
            <br />
            <br />
          ...
          <motion.ul style={{ width: "100%" }} variants={containerVariant}>
            <motion.li className="second-text" variants={fadeUp}>
              Strategic Integration Architecture Future-ready integration
              frameworks aligned with business processes, operational systems,
              and scalability goals.
            </motion.li>

            <motion.li className="second-text" variants={fadeUp}>
              Performance-Driven Connectivity High speed, stable, & reliable
              integrations designed for real-time data synchronization &
              optimized cross-platform performance.
            </motion.li>

            <motion.li className="second-text" variants={fadeUp}>
              Standardized APIs, modular frameworks, and clean integration logic
              ensure consistency, maintainability, and enterprise-grade
              execution.
            </motion.li>

            <motion.li className="second-text" variants={fadeUp}>
              Automated data exchange and workflow synchronization reduce manual
              errors, eliminate redundancy, and enhance productivity across
              departments.
            </motion.li>

            <motion.li className="second-text" variants={fadeUp}>
              Secure API protocols, access control mechanisms, encrypted data
              transfer, and compliance driven standards ensure trust,
              protection, & long term system stability.
            </motion.li>
          </motion.ul>
        </motion.div>
      </section>
