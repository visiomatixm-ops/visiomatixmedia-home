      ...
      <div className="service2-container">
        ...
        >
          <div className="column-2 custom-border-2 right-pad-30">
            <Benefit
              img={frame1}
              title="Performance Strategy & Engineering"
          ...
          <div className="column-2">
            <Benefit
              img={frame3}
              title="High-Speed System Architecture"
        ...
        >
          <p className="second-text">
            Web Performance, Security & Optimization Services at Visiomatix
            Media go beyond technical improvements we build resilient, high
            speed, and secure digital ecosystems that sustain long term business
            growth. Our structured, performance focused approach ensures every
            platform operates at peak efficiency, remains protected against
            vulnerabilities, and continuously evolves to meet scaling demands
          ...
          <motion.ul variants={containerVariant}>
            <motion.li className="second-text" variants={fadeUp}>
              Performance Engineering Excellence advanced system tuning and
              infrastructure optimization designed to maximize speed,
              responsiveness, and operational efficiency.
            </motion.li>

            <motion.li className="second-text" variants={fadeUp}>
              Proactive Security Frameworks Robust security layers, data
              protection mechanisms, vulnerability mitigation strategies
              safeguard digital assets & ensure platform integrity.
            </motion.li>

            <motion.li className="second-text" variants={fadeUp}>
              Continuous Optimization & Monitoring ongoing performance audits,
              real-time monitoring, and technical enhancements to maintain long
              term stability and reliability.
            </motion.li>

            <motion.li className="second-text" variants={fadeUp}>
              Scalable Infrastructure & System Stability architectures built to
              handle growth, traffic surges, & evolving business requirements
              without compromising performance.
            </motion.li>

            <motion.li className="second-text" variants={fadeUp}>
              Operational Reliability & Digital Resilience Structured processes
              & technical governance that ensure consistent uptime, system
              durability, & sustainable digital performance.
            </motion.li>
          </motion.ul>
        </motion.div>
      </div>
