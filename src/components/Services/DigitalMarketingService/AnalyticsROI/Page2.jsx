      ...
      <section className="digital-marketing-services-2-2">
        ...
        >
          <div className="column-2 custom-border-2 right-pad-30">
            ...
            <Benefit
              img={frame2}
              title="Qualified Growth & Revenue Attribution"
          ...
          <div className="column-2 custom-border-2 left-pad-50 right-pad-30">
            <Benefit
              img={frame6}
              title="Performance Driven Insight Capture"
          ...
          <div className="column-2 left-pad-50 right-pad-30">
            <Benefit
              img={frame3}
              title="Consistent Data & Reporting Control"
            ...
            <Benefit
              img={frame4}
              title="Scalable Growth with ROI Efficiency"
        ...
        >
          <p className="second-text">
            Analytics & ROI Tracking with Visiomatix Media is built for brands
            that demand clarity, accountability, and measurable business
            performance. We move beyond basic reporting to engineer structured,
            insight driven analytics ecosystems that strengthen decision making,
            optimize marketing efficiency, and support predictable growth. Our
            approach integrates advanced data tracking, attribution
            intelligence, and disciplined performance analysis to ensure every
            metric, interaction, and conversion contributes to long term
            business value. Through actionable insights, platform specific
            measurement frameworks, and continuous performance refinement, we
            transform raw data into clarity, informed decisions, and sustainable
            ROI impact.
            <br />
            <br />
          ...
          <motion.ul style={{ width: "100%" }} variants={containerVariant}>
            <motion.li className="second-text" variants={fadeUp}>
              Strategic Performance Measurement Track high impact KPIs with
              precision to ensure every initiative aligns with business
              objectives and measurable outcomes.
            </motion.li>

            <motion.li className="second-text" variants={fadeUp}>
              Performance Led ROI Growth ROI focused insights driven by data,
              analytics, and continuous optimization to improve efficiency and
              decision-making.
            </motion.li>

            <motion.li className="second-text" variants={fadeUp}>
              Controlled Data & Reporting Integrity Maintain clarity,
              consistency, and accuracy across dashboards and reports to protect
              data reliability and trust.
            </motion.li>

            <motion.li className="second-text" variants={fadeUp}>
              Qualified Insights & Outcome Attribution Connect marketing
              activity to real business results through accurate attribution and
              conversion tracking.
            </motion.li>

            <motion.li className="second-text" variants={fadeUp}>
              Scalable & Cost Efficient Measurement Optimize tracking frameworks
              and reporting systems to support sustainable growth, efficiency, &
              long term ROI control.
            </motion.li>
          </motion.ul>
        </motion.div>
      </section>
