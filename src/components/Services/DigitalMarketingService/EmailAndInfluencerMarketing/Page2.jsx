      ...
      <section className="digital-marketing-services-2-2">
        ...
        >
          <div className="column-2 custom-border-2 right-pad-30">
            <Benefit
              img={frame1}
              title="Strategic Relationship Positioning"
            ...
            <Benefit
              img={frame2}
              title="Qualified Lead Nurturing & Demand Generation"
          ...
          <div className="column-2 custom-border-2 left-pad-50 right-pad-30">
            <Benefit
              img={frame6}
              title="Performance Driven Engagement & Influence"
          ...
          <div className="column-2 left-pad-50 right-pad-30">
            <Benefit
              img={frame3}
              title="Consistent Brand Voice & Message Control"
            ...
            <Benefit
              img={frame4}
              title="Scalable Growth with Authentic Reach"
        ...
        >
          <p className="second-text">
            Email & Influencer Marketing with Visiomatix Media is designed to
            build credibility, trust, and measurable influence at scale. We
            craft high engagement email journeys and strategically aligned
            influencer ecosystems that strengthen brand authority, amplify
            reach, and drive consistent, performance led growth. By combining
            data driven personalization, precise audience segmentation, and
            carefully curated creator partnerships, we ensure every message and
            collaboration delivers relevance and impact. Our approach transforms
            engagement into qualified demand and long term brand value while
            preserving authenticity, consistency, and message integrity across
          ...
          <motion.ul style={{ width: "100%" }} variants={containerVariant}>
            <motion.li className="second-text" variants={fadeUp}>
              Strategic Influence & Engagement Capture Reach high intent
              audiences with precision through personalized email journeys and
              aligned influencer partnerships.
            </motion.li>

            <motion.li className="second-text" variants={fadeUp}>
              Performance Led Relationship Growth ROI driven execution powered
              by data and continuous optimization to drive measurable influence
              and conversions.
            </motion.li>

            <motion.li className="second-text" variants={fadeUp}>
              Controlled Brand Voice & Messaging Integrity Maintain consistent
              brand tone, credibility, & narrative across email communications
              and influencer collaborations.
            </motion.li>

            <motion.li className="second-text" variants={fadeUp}>
              Qualified Demand & Conversion Impact Transform engagement into
              high quality leads, informed decision making, and measurable
              business outcomes.
            </motion.li>

            <motion.li className="second-text" variants={fadeUp}>
              Scalable & Cost Efficient Growth Ecosystems Optimize outreach,
              partnerships, & performance to build sustainable, scalable growth
