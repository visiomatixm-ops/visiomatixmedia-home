    ...
    <section className="digital-marketing-services-2-2">
      ...
      <div className="benefites-containr-2">
        <div className="column-2 custom-border-2 right-pad-30">
          <Benefit
            img={frame1}
            title=" Strategic Storytelling & Motion Positioning"
          ...
          <Benefit
            img={frame2}
            title="Conversion Focused Motion Communication"
        ...
        <div className="column-2 custom-border-2 right-pad-30">
          <Benefit
            img={frame6}
            title="Performance Driven Engagement & Retention"
          ...
          <Benefit
            img={frame5}
            title="Data Informed Motion Optimization"
        ...
        <div className="column-2">
          <Benefit
            img={frame3}
            title="Consistent Brand Motion & Visual Control"
          ...
          <Benefit
            img={frame4}
            title="Scalable Growth with Motion Reliability"
      ...
      <div className="second-container-2">
        <p className="second-text">
          Motion Graphics & Animation with Visiomatix Media are designed to
          build clarity, emotional connection, and measurable brand impact at
          scale. We craft high engagement motion narratives and animation
          systems that strengthen brand storytelling, amplify message recall,
          and deliver consistent, performance led visibility across digital
          platforms. By combining strategic storytelling, precision led motion
          design, and data informed creative refinement, we ensure every
          animation delivers relevance, clarity, and impact. Our approach
          transforms visual engagement into audience retention and long term
          brand value while preserving authenticity, consistency, and message
          integrity across every motion touchpoint.
          <br />
          <br />
        ...
        <ul className="highlights-list">
          <li className="second-text">
            Strategic Storytelling & Audience Engagement Capture attention and
            connect audiences through purpose-led motion narratives designed for
            clarity and impact.
          </li>
          <li className="second-text">
            Performance Led Motion Engagement Data informed motion design
            optimized for attention, retention, and measurable engagement across
            digital platforms.
          </li>
          <li className="second-text">
            Controlled Brand Motion & Visual Integrity Maintain consistent
            motion language, visual style, and storytelling tone across all
            animations and brand touchpoints.
          </li>
          <li className="second-text">
            Turn visual engagement into recall, action, and meaningful business
            outcomes through strategic motion.
          </li>
          <li className="second-text">
            Build modular animation systems that scale across campaigns and
            platforms while maintaining quality and brand value.
          </li>
        </ul>
      </div>
    </section>
