...
function AppContent() {
  ...
  useEffect(() => {
    ...
    // Update route-specific title, meta description, robots, OG URL, and canonical URL.
    const pageSeo = getSeoConfigForPath(location.pathname);
    updateMetaTags(
      pageSeo.title,
      pageSeo.description,
      pageSeo.keywords,
      ...
      <Routes>
        ...
        />
         ...
         {/* Branding and Strategy */}
          ...
          <Route path="/services/scalable-brand-architecture" element={<><ScalableBrandArchitecture/><HomePage9/></>} />
         ...
         <Route path="/services/post-production" element={<><PostProduct/><HomePage9/></>}/>
         ...
         <Route path="/services/visual-effects" element={<><VisualEffects/><HomePage9/></>}/>
         ...
         <Route path="/services/performance-security-optimization" element={<><PerformanceSecurityoptimization/><HomePage9/></>}/>
         ...
         {/* Legacy typo/case redirects kept out of the sitemap to consolidate signals. */}
         <Route path="/services/design-Creative-Services" element={<Navigate to="/services/design-creative-services" replace />} />
         <Route path="/services/design-creative" element={<Navigate to="/services/design-creative-services" replace />} />
         <Route path="/services/scalable-bradn-architecture" element={<Navigate to="/services/scalable-brand-architecture" replace />} />
         <Route path="/services/post-product" element={<Navigate to="/services/post-production" replace />} />
         <Route path="/services/visual-effests" element={<Navigate to="/services/visual-effects" replace />} />
         <Route path="/services/visual-effects-vfx" element={<Navigate to="/services/visual-effects" replace />} />
         <Route path="/services/Mobile-App-Development" element={<Navigate to="/services/mobile-app-development" replace />} />
         <Route path="/services/Maintenance-Support" element={<Navigate to="/services/maintenance-support" replace />} />
         <Route path="/services/performance-sercurity-optimization" element={<Navigate to="/services/performance-security-optimization" replace />} />
         <Route path="/services/mobile-app-development/" element={<Navigate to="/services/mobile-app-development" replace />} />
         <Route path="/services/maintenance-support/" element={<Navigate to="/services/maintenance-support" replace />} />
         <Route path="/services/analytics-roi" element={<Navigate to="/services/analytics-and-roi-tracking" replace />} />
         <Route path="/services/ecommerce-marketing" element={<Navigate to="/services/ecommerce-and-marketing" replace />} />
         <Route path="/services/web-app-development" element={<Navigate to="/services/web-and-app-development-services" replace />} />
         <Route path="/services/motion-graphics-animation" element={<Navigate to="/services/motion-graphics" replace />} />
         <Route path="/services/enterprise-internal-systems" element={<Navigate to="/services/enterprise-internal-system" replace />} />
